...
import static com.example.lpoon2.assignment30.R.id.container;
...
public class Follower extends Fragment {
     ...
     */
    public static Follower newInstance(String param1) {
        Follower fragment = new Follower();
    ...
    /**
     * Given a list of followers, we want to tranform it to a list of FollowerObj
     * , which stores all the information of a follower
     * @param follow_url
     * @return
     */
    ...
    /**
     * An onclick function for the option menu
     * @param item
     * @return
     */
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.store){
            // store list of followers in firebase
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            for(int i = 0; i < followerList.size(); i++){
                DatabaseReference myRef = database.getReference("follower/lpoon2");
